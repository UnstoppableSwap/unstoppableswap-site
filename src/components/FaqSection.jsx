...
export const FaqSection = () => {
  ...
  const questionsAndAnswers = [
    ...
    },
    {
      ...
      answer: (
        <>
          BTC-XMR Atomic Swaps were made possible by the rigorous research of
          some ingenious cryptographers. Specifically the research made by the
          COMIT Team and the Farcaster Project. If you want to know learn more
          about BTC-XMR Atomic Swaps, please read the blog posts by the{" "}
          <a
    ...
    },
    {
      ...
      answer: (
        <>
          The best way to contribute to the emergence of protocols that enable
          the trustless exchange of Monero with other assets is to contribute
          with code or by building infrastructure like this page around those
          protocols. Please visit the COMIT team's Github repository if you are
          a developer and want to help. You can also choose to help us fund our
    ...
    },
    {
    ...
    },
      {
          ...
          answer: <>
              Yes, we provide an easy to use API for anyone to retrieve information about swap providers. Requests are made using standard HTTP or the socket.io protocol and responses are returned in JSON format.
              <br />
              <APITable />
          </>
      },
