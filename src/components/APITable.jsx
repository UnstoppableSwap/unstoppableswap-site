...
function APITable() {
    ...
    return <Box className={classes.tableOuter}>
            ...
            <Table>
                ...
                <TableBody>
                    ...
                    <TableRow>
                        ...
                        <TableCell>
                            <SyntaxHighlighter language="json" style={a11yDark}>{exampleApiResponse}</SyntaxHighlighter>
                        </TableCell>
                        <TableCell>
                    ...
                    <TableRow>
                        ...
                        <TableCell>
                            <SyntaxHighlighter language="javascript" style={a11yDark}>{httpCodeExample}</SyntaxHighlighter>
                        </TableCell>
                        <TableCell>
