...
import {
    ...
    TableRow,
    Paper,
    Switch, FormControlLabel, Box, makeStyles, CircularProgress, LinearProgress, TableBody, Typography
...
function getCombinedMultiAddr(provider: {multiAddr: string, peerId: string} ): string {
...
export default function ProviderTable() {
    ...
    const providers = useStore(state => {
        ...
        return state.providerList ? state.providerList.filter((provider) => !provider.testnet) : null;
    });
            ...
            <TableContainer component={Paper} className={classes.container}>
                <Box style={{
                    ...
                    <Typography variant="caption">
                        In case you insist on using a different software from the GUI, you can still make use of this list of market makers to connect with.
                    </Typography>
                </Box>
                <Table size="small">
                    <TableHead>
                        ...
                        {providers ? providers.map((provider, index) => {
                            return (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>
                                        <ProviderCopyButton multiAddr={provider.multiAddr} peerId={provider.peerId}/>
                                    </TableCell>
                                </TableRow>
                            )
                        }) : <TableRow>
